...
let hatsURL = `https://raw.githubusercontent.com/fjajktjwjmtt/mpp-hats/main/export`;
let hatsHistory = {}
...
HatE.on('update hat', (p, url) => {
    // setTimeout(() => { // timeout to fix race condition, apparently
        ...
        // url = url || `https://raw.githubusercontent.com/the-dev-channel/mpp-hats/main/export/santa.gif`;
        url = `${hatsURL}/${url}.gif`;
...
HatE.on('load', () => {
    ...
    // add gui
    let btnOpenMenu = `<button id="hats-btn" class="top-button icon-button"><img src="${hatsURL}/tophat.gif" /><p>Hats</p></button>`;
